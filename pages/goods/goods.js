  ...
  data: {
    ...
    products: [
      ...
      },
      {
        ...
        price: 9.9,
        sales: 350,  // 假设有销量字段
        image: 'https://www.artisan.com.tw/images/blogs/20240801094015.jpg',
      ...
      },
      {
        ...
        price: 19.9,
        sales: 120,  // 假设有销量字段
        image: 'https://p3-sdbk2-media.byteimg.com/tos-cn-i-xv4ileqgde/36032d062f964824aee26442fb622f61~tplv-xv4ileqgde-resize-w:750.image',
      ...
      },
      {
        ...
        price: 125.0,
        sales: 120,  // 销量字段
        image: 'https://www.sesameoil.com.tw/Archive/_tw/upload/honey.jpg',
        category: ['deco']  // 摆件
      },
      {
        id: 5,
